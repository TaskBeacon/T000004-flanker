...
| `trigger_scheme` | `triggers.map` | fixation/stimulus/response/timeout/block/experiment trigger set | `W2150902492` | Stage-separated trigger coding is needed for synchronized EEG/behavioral analysis. | `inferred` | Timeout branch uses `response_timeout` during response capture. |
